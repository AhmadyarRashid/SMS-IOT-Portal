...
const STEPS = [
  {
    ...
    detail: 'KPIs, live readings, a 7-day alarm chart, and a recent-activity strip — all driven by the same three cached queries. No per-widget calls.',
    tryHref: '/',
  ...
  },
  {
    id: 'sites',
    title: 'Your sites',
    tagline: 'One card per property',
    detail: 'Each site shows mood-tinted health, live readings, and quick actions. Drill in to see every device grouped by category.',
    tryHref: '/sites',
  ...
  },
  {
    ...
    tagline: 'The icon is the switch',
    detail: 'On lights, plugs, fans, locks, and alarms, tapping the round icon toggles the device. Sensors open their detail page instead.',
    tryHref: '/sites',
  ...
  },
  {
    id: 'quick',
    title: 'Quick access',
    tagline: 'Your favourites, rearranged',
    detail: 'Pin the devices you use most and drag to rearrange them like iPhone widgets. Small or large — your call.',
    tryHref: '/quick',
  ...
  },
  {
    ...
    detail: 'Every numeric or boolean attribute plots as a chart with selectable 1h / 24h / 7d / 30d ranges. Booleans render as clean step lines.',
    tryHref: '/sites',
    tryLabel: 'Try it',
  },
  {
    ...
    detail: 'Cross-site alarm list with severity and status transitions. Move alarms from Open through Acknowledged to Resolved.',
    tryHref: '/alarms',
  ...
  },
  {
    ...
    detail: 'Every geocoded site pins on a themed map. Click a marker or the sidebar entry to fly to it.',
    tryHref: '/map',
    tryLabel: 'Open map',
  },
  {
    id: 'settings',
    title: 'Make it yours',
    tagline: 'Theme, density, tips',
    detail: 'Switch between dark and light, tighten the compact density, or bring dismissed tips back from the bottom of this page.',
    tryHref: '/settings',
